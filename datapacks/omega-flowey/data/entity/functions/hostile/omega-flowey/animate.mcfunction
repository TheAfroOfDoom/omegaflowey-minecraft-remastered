...
execute as @e[tag=aj.petal_pipe_circle.root] run function entity:hostile/omega-flowey/animate/petal_pipe_circle/default
execute as @e[tag=aj.petal_pipe_middle.root] run function entity:hostile/omega-flowey/animate/petal_pipe_middle/default
