...
execute if score @s math.0 matches 0 run function entity:hostile/omega-flowey/attack/flies/executor/loop/indicator/presummon

# Terminate
execute if score @s attack.clock.i = @s attack.executor.clock.length run function entity:hostile/omega-flowey/attack/flies/executor/terminate
