...
# Summon bullet
summon minecraft:item_display ~ ~ ~ {CustomName:'"X-Bullets-Upper Bullet"', Tags:["omega-flowey-remastered","hostile","omega-flowey","attack","attack-bullet","attack-bullet-new","x-bullets-upper"], interpolation_duration: 1, teleport_duration: 1, item_display: "head", item: {id: "minecraft:quartz_block", Count: 1b, tag: {}}}
