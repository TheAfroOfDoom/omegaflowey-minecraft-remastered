execute as @e[tag=should-save-state] at @s run function entity:hostile/omega-flowey/attack/homing-vines-save-states/executor/states/load_all_states/as_entity
