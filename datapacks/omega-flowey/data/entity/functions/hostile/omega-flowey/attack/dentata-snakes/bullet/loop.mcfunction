...
execute if score @s attack.clock.i matches 500 run tag @s add can-escape-arena

# Terminate after X seconds
execute if score @s attack.clock.i matches 600.. run function entity:hostile/omega-flowey/attack/dentata-snakes/bullet/terminate
