...
execute if score @s math.0 matches 0 at @r[team=player] run function entity:hostile/omega-flowey/attack/homing-vines/executor/loop/summon_indicator

# Terminate
execute if score @s attack.clock.i = @s attack.executor.clock.length run function entity:hostile/omega-flowey/attack/homing-vines/executor/terminate
