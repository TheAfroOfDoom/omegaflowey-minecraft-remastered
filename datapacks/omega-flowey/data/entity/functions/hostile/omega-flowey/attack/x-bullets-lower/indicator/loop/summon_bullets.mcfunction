...
execute unless entity @s[scores={attack.bullets.remaining=..0}] run function entity:hostile/omega-flowey/attack/x-bullets-lower/indicator/loop/summon_bullets with storage aj:bone.position
