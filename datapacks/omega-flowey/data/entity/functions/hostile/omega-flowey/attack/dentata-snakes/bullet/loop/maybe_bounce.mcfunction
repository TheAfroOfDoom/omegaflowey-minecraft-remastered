...
data merge storage utils:bounce { x_negative_x: -21, x_negative_dx: 50 }
data merge storage utils:bounce { x_positive_x: 21, x_positive_dx: -50 }
data merge storage utils:bounce { z_negative_z: -3, z_negative_dz: 25 }
data merge storage utils:bounce { z_positive_z: 18, z_positive_dz: -25 }
data merge storage utils:bounce { y: 30, dy: 10 }
