...
# TODO this needs to NOT be a distance check
execute if score @s attack.bullets.clock.i matches 0 as @e[tag=aj.upper_eye.root,sort=nearest,limit=1] run function animated_java:upper_eye/apply_variant/colorful
