...
function entity:soul/soul_0/executor/loop/bullet/presummon
...
execute unless score @s soul.bullet.position.x > @s soul.bullet.position.x.end run function entity:soul/soul_0/executor/loop/bullet/iterate_grid
