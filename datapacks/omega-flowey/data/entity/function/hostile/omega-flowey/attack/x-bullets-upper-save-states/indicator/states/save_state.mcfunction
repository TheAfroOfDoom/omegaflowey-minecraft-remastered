...
data modify storage attack:x-bullets-upper-save-states current_state.summon_function set value "entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/indicator/states/load_state/resummon"
