...
execute if score @s attack.clock.i matches 26..34 at @r[team=player] run function entity:hostile/omega-flowey/attack/homing-vines-save-states/indicator/summon
