...
execute as @e[tag=player-marker,tag=homing-vines-save-states] run function entity:hostile/omega-flowey/attack/homing-vines-save-states/player/marker/terminate
