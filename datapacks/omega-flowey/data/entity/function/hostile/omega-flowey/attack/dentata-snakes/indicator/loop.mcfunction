...
# Summon bullet
execute if score @s attack.bullets.clock.i = @s attack.bullets.clock.delay if score @s attack.bullets.remaining matches 1.. run function entity:hostile/omega-flowey/attack/dentata-snakes/indicator/loop/presummon_bullet
