...
function entity:hostile/omega-flowey/attack/flies/reset_scores
function entity:hostile/omega-flowey/attack/friendliness-pellets/reset_scores
function entity:hostile/omega-flowey/attack/homing-vines/reset_scores
function entity:hostile/omega-flowey/attack/x-bullets-lower/reset_scores
function entity:hostile/omega-flowey/attack/x-bullets-upper/reset_scores
