...
execute if score #homing-vine-save-states.did_player_take_damage attack.flag matches 1 run function entity:hostile/omega-flowey/attack/homing-vines-save-states/executor/loop/after_load_state
execute if score #homing-vine-save-states.did_player_take_damage attack.flag matches 1 run return 0
