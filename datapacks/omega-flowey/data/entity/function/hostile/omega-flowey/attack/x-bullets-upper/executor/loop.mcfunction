...
execute if score @s attack.clock.i matches 0 run \
  function entity:hostile/omega-flowey/attack/x-bullets-upper/executor/loop/pause_eye with storage omegaflowey:bossfight
...
execute if score @s attack.clock.i >= @s attack.executor.clock.length run \
  function entity:hostile/omega-flowey/attack/x-bullets-upper/executor/terminate with storage omegaflowey:bossfight
