...
$execute at $(attack_upper_eye_right_locator_uuid) summon minecraft:marker run \
  function entity:hostile/omega-flowey/attack/x-bullets-upper/indicator/initialize/right
$execute at $(attack_upper_eye_left_locator_uuid) summon minecraft:marker run \
  function entity:hostile/omega-flowey/attack/x-bullets-upper/indicator/initialize/left
