...
execute if entity @s[tag=omegaflowey.player.fighting_flowey] run function entity:directorial/boss_fight/summit/player/active/leave_and_rejoin
execute if entity @s[tag=omegaflowey.player.in_queue] run function entity:directorial/boss_fight/summit/player/queue/leave_and_rejoin
