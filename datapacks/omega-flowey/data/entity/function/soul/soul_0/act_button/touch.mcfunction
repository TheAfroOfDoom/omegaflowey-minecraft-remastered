...
summon block_display -2.5 49.5 -34.0 \ 
    ...
    Passengers:[ \ 
        {id:"minecraft:text_display", \
            ...
            Rotation:[-180f,0f], \
            transformation:[30.0150f,0.0000f,0.0000f,0.0000f,0.0000f,30.0700f,0.0000f,0.4900f,0.0000f,0.0000f,30.0100f,-0.0100f,0.0000f,0.0000f,0.0000f,1.0000f] \
          }, \
        {id:"minecraft:text_display", \
            Tags:[call-for-help-display], \ 
            text:"{\"text\":\"* You Called For Help. . .\",\"color\":\"#FFFFFF\",\"font\":\"minecraft:uniform\"}", \
            ...
            default_background:false, \ 
            Rotation:[-180f,0f], \ 
            transformation:[30.0000f,0.0000f,0.0000f,0.0000f,0.0000f,30.0000f,0.0000f,0.5000f,0.0000f,0.0000f,30.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f]\
          } \
        ] \
      }
