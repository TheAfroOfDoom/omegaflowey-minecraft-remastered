...
function entity:soul/soul_5/executor/initialize/presummon
...
execute if score @s soul.bullet.position.x > @s soul.bullet.position.x.end run function entity:soul/soul_5/executor/initialize/post_iterate_grid

# iterate again unless we pass the x-bound
execute unless score @s soul.bullet.position.x > @s soul.bullet.position.x.end run function entity:soul/soul_5/executor/initialize/iterate_grid
