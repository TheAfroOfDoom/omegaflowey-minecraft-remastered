...
execute store result storage soul:soul_5 yaw float 1 run scoreboard players get @s soul.bullet.position.yaw

# Add tag to act_button so it can begin moving
execute as @e[tag=soul_5,tag=act-button] run function entity:soul/soul_5/act_button/initialize/can_move
