...
execute if score @s soul.bullet.position.z matches -2600.. run function entity:soul/soul_5/bullet/terminate

# Rotate animation
execute unless entity @s[tag=shaking] run teleport @s ~ ~ ~ ~-6 ~

# Shaking animation
execute if entity @s[tag=shaking] run function entity:soul/soul_5/bullet/loop/shaking
