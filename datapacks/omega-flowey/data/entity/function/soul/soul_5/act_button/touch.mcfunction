...
function entity:directorial/boss_fight/summit/soul_origin/at/position { command: "execute positioned ~ ~7.0 ~-9.5 run function entity:soul/shared/call_for_help_display/summon" }
