execute if entity @s[tag=act-button] run function entity:soul/soul_5/act_button/loop
execute if entity @s[tag=soul-bullet] run function entity:soul/soul_5/bullet/loop
execute if entity @s[tag=soul-executor] run function entity:soul/soul_5/executor/loop
execute if entity @s[tag=soul-heal] run function entity:soul/soul_5/heal/loop
