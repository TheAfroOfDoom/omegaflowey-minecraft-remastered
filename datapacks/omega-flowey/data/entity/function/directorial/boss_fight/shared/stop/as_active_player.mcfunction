...
# Teleport player to finish position unless stop reason is that they have left the arena bounds
execute unless score #omegaflowey.bossfight.stop_reason global.flag matches 2 run teleport @s -141.5 43.0 25.5 -45 0
