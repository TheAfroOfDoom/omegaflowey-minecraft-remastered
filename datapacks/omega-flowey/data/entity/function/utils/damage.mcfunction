...
$execute unless entity $(boss_fight_uuid) as @a[distance=..$(radius),tag=omegaflowey.player.fighting_flowey] run damage @s $(damage) minecraft:mob_projectile
$execute if entity $(boss_fight_uuid) as @a[distance=..$(radius),tag=omegaflowey.player.fighting_flowey] run damage @s $(damage) minecraft:mob_projectile by $(boss_fight_uuid)
