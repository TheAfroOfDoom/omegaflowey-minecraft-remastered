...
$execute unless entity @e[tag=boss_fight] as @a[distance=..$(radius),tag=omegaflowey.player.fighting_flowey] run damage @s $(damage) minecraft:mob_projectile
$execute if entity @e[tag=boss_fight] as @a[distance=..$(radius),tag=omegaflowey.player.fighting_flowey] run damage @s $(damage) minecraft:mob_projectile by @e[tag=boss_fight,limit=1]
