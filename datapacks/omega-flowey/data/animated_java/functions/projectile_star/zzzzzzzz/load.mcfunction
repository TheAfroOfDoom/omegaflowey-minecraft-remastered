...
scoreboard objectives add aj.projectile_star.animation.spin.local_anim_time dummy
scoreboard objectives add aj.projectile_star.animation.spin_and_grow.local_anim_time dummy
scoreboard objectives add aj.projectile_star.animation.spin.loop_mode dummy
scoreboard objectives add aj.projectile_star.animation.spin_and_grow.loop_mode dummy
scoreboard players set $aj.projectile_star.animation.spin aj.id 0
scoreboard players set $aj.projectile_star.animation.spin_and_grow aj.id 1
scoreboard players set $aj.projectile_star.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.projectile_star.export_version aj.i -1608619312
