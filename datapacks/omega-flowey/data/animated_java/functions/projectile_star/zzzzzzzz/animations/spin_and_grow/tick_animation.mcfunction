...
execute if score @s aj.projectile_star.animation.spin_and_grow.local_anim_time matches 60.. run function animated_java:projectile_star/zzzzzzzz/animations/spin_and_grow/end