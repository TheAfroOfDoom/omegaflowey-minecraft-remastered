...
execute if score #animation aj.i = $aj.pipe_upper_eye.animation.pulsate2 aj.id run function animated_java:pipe_upper_eye/zzzzzzzz/animations/pulsate2/apply_frame_as_root
execute if score #animation aj.i = $aj.pipe_upper_eye.animation.pulsate2 aj.id run scoreboard players operation @s aj.pipe_upper_eye.animation.pulsate2.local_anim_time = #frame aj.i
