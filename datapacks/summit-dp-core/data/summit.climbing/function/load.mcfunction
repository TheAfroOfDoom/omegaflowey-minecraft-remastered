...
data modify storage summit.climbing:master blocks.block_states set value {use_down_state: false, group_1: {north: "white_wool", north_east: "light_gray_wool", east: "gray_wool", south_east: "black_wool", south: "brown_wool", south_west: "red_wool", west: "orange_wool", north_west: "yellow_wool", down: "lime_wool"}, group_2: {north: "white_concrete", north_east: "light_gray_concrete", east: "gray_concrete", south_east: "black_concrete", south: "brown_concrete", south_west: "red_concrete", west: "orange_concrete", north_west: "yellow_concrete", down: "lime_concrete"}}
...
execute store result storage summit.climbing:master 3q_rotation_speed int 0.75 run data get storage summit.climbing:master rotation_speed
