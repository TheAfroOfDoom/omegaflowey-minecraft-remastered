...
$data merge entity $(bone_thumb_right) {transformation: [-0.5176f,1.9319f,0f,-1.7262f,0f,0f,2f,1.5f,1.9319f,0.5176f,0f,-0.0807f,0f,0f,0f,1f],start_interpolation: 0,interpolation_duration: 1}
