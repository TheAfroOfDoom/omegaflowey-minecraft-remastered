...
execute unless entity @e[type=item_display, tag=summit.wind.collision, distance=..25, limit=1] run return fail
...
tag @e[tag=summit.wind.collision, distance=..25] remove summit.wind.colliding
execute as @e[type=item_display, tag=summit.wind.collision, distance=..25] run function summit.wind:physics/plane/check_ball_collision
execute unless entity @e[type=item_display, tag=summit.wind.colliding, distance=..25, limit=1] run scoreboard players set @s summit.wind.timer 0
execute unless entity @e[type=item_display, tag=summit.wind.colliding, distance=..25, limit=1] run return fail
...
execute if score dist summit.wind.calc matches -1999..0 rotated as @n[type=item_display, tag=summit.wind.colliding, distance=..25] run function player_motion:api/launch_local_xyz
