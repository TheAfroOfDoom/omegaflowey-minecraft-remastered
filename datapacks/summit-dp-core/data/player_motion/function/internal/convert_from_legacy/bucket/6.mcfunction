...
execute store result storage player_motion:tmp convert double 0.991788 run scoreboard players get #crystal player_motion.internal.dummy
...
scoreboard players operation #crystal player_motion.internal.dummy += #convert.06.adder player_motion.internal.const