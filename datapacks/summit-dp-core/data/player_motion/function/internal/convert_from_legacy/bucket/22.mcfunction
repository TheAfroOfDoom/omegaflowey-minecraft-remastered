...
execute store result storage player_motion:tmp convert double 0.805033 run scoreboard players get #crystal player_motion.internal.dummy
...
scoreboard players operation #crystal player_motion.internal.dummy += #convert.22.adder player_motion.internal.const