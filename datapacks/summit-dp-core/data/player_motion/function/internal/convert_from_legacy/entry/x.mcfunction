execute store result score #bucket_index player_motion.internal.dummy run scoreboard players operation #crystal player_motion.internal.dummy = $x player_motion.api.launch
...
execute store result score #x player_motion.internal.dummy store result storage player_motion:internal/temp matrix.x double 1 run function player_motion:internal/convert_from_legacy/index with storage player_motion:internal/temp convert
