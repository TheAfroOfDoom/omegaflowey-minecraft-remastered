execute store result score #bucket_index player_motion.internal.dummy run scoreboard players operation #crystal player_motion.internal.dummy = $z player_motion.api.launch
