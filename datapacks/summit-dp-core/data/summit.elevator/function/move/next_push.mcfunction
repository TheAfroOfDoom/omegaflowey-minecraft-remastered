...
scoreboard players operation $step summit.elevator.timer %= $phase summit.elevator.timer
...
execute if score @s summit.elevator.timer matches 9 run function summit.elevator:move/structure with entity @s data.summit.elevator.chains
execute if score $step summit.elevator.timer matches 9 positioned ~ ~1 ~ run function summit.elevator:move/structure with entity @s data.summit.elevator.chains
...
execute if score $step summit.elevator.timer matches 18 run function summit.elevator:move/structure_stop with entity @s data.summit.elevator.chains
...
execute if score $step summit.elevator.timer matches 18 as @a[gamemode=!spectator, distance=..50] at @s if score @s summit.elevator.id = #curr summit.elevator.id run function summit.elevator:move/tp with storage summit:temp elevator
