...
data modify entity @s item.components."minecraft:custom_data".effects set from storage summit.vehicles:temp effects
...
data modify entity @s item.components."minecraft:custom_data".exit_triggers set from storage summit.vehicles:temp exit_triggers
