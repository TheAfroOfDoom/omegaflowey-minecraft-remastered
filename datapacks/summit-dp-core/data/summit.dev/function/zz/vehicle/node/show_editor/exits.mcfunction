$data modify storage summit.vehicles:temp dialog.body.contents append value [{text: "#$(i):  ", color: "gray"}, {text: "$(value)", color: "white"}, {text: "  [\u270f]", color: "yellow", click_event: {action: "run_command", command: 'function summit.dev:zz/vehicle/node/edit {uuid: "$(uuid)", path: "node.triggers.exit[$(i)]", value: "$(value)"}'}, hover_event: {action: "show_text", value: "Edit this exit trigger"}}, {text: " [-]", color: "red", click_event: {action: "run_command", command: 'function summit.dev:zz/vehicle/node/remove_entry {uuid: "$(uuid)", path: "node.triggers.exit", i: -1}'}, hover_event: {action: "show_text", value: "Deletes this exit trigger"}}]
