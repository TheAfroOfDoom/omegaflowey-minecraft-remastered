$data modify storage summit.vehicles:temp dialog.body.contents append value [{text: "#$(i):  ", color: "gray"}, {text: "$(value)", color: "white"}, {text: "  [\u270f]", color: "yellow", click_event: {action: "run_command", command: 'function summit.dev:zz/vehicle/track/edit_value {name: "$(name)", path: "track.path[$(i)]", value: "$(value)"}'}, hover_event: {action: "show_text", value: "Edit this node"}}, {text: " [-]", color: "red", click_event: {action: "run_command", command: 'function summit.dev:zz/vehicle/track/remove_entry {name: "$(name)", path: "track.path", i: -1}'}, hover_event: {action: "show_text", value: "Deletes this node"}}]
