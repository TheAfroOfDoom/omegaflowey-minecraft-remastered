...
tellraw @a[tag=reef.permissions.see_debug] [['', {'text': '[', 'color': '#6e3787'}, {'text': 'reef', 'color': '#ed2de3'}, {'text': '] ', 'color': '#6e3787'}], [{'text': '', 'color': '#fa4267'}, 'Slideshow page index cannot exceed page bounds (', {'score': {'name': '#tmp', 'objective': 'reef.zzzinternals.screen.slideshow.pages'}}, ')']]
return fail
