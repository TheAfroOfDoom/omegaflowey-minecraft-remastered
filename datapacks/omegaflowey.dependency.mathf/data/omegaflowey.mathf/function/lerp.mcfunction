...
execute unless score i2 mathf.io matches 0..100 run data modify storage omegaflowey.mathf:throw warning set value "Interpolant was clamped from 0-100. (omegaflowey.mathf:lerp)"
