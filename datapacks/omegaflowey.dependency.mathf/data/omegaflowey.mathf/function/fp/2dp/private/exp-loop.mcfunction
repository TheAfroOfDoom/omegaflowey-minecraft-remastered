#> omegaflowey.mathf:fp/2dp/private/exp-loop
# @within function omegaflowey.mathf:fp/2dp/exp
...
execute if score powerCount mathf.data < i1 mathf.io run function omegaflowey.mathf:fp/2dp/private/exp-loop
