...
execute if score i0 mathf.io matches ..-1 run data modify storage mathf:throw error set value "Cannot Square Root a negative number. (omegaflowey.mathf:sqrt)"
...
function omegaflowey.mathf:private/sqrt-loop
