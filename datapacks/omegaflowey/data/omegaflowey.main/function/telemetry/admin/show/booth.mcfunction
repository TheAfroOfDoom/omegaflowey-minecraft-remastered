...
# Return early if there is no booth data
execute if score @s omegaflowey.math.0 matches 0 run return run function omegaflowey.utils:log/self { text_component: '[ \
  "", \
  { "text": "No booth data to display." } \
]'}
