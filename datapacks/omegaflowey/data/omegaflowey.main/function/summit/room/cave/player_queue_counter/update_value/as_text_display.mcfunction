execute if score #omega-flowey.bossfight.player_queue_count omegaflowey.global.flag matches 0 run \
...
execute store result storage omegaflowey:bossfight player_queue_count int 1 run \
  scoreboard players get #omega-flowey.bossfight.player_queue_count omegaflowey.global.flag
