...
execute if score @s soul.bullet.position.x matches -3071..3170 if score @s soul.bullet.position.z matches -9575..-4635 run scoreboard players set @s omegaflowey.math.0 1

# Summon bandaid at current position
# ONLY if this sword is visible within the soul arena's bounds
execute if score @s omegaflowey.math.0 matches 1 store result storage soul:soul_0.bullet x float 0.01 run scoreboard players get @s soul.bullet.position.x
...
execute if score @s omegaflowey.math.0 matches 1 store result storage soul:soul_0.bullet z float 0.01 run scoreboard players get @s soul.bullet.position.z
