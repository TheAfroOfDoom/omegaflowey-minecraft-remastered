...
execute if score @s soul.clock.i matches 0 run function omegaflowey.entity:soul/soul_0/executor/initialize/pre_iterate_grid

# Begin moving bullets after 20 ticks (1s)
execute if score @s soul.clock.i matches 20 run function omegaflowey.entity:soul/soul_0/executor/loop/start_moving_bullets

# Replay song after it ends (only if we haven't yet started `saved` state)
execute if score #soul_0.saved soul.flag matches 0 if score @s soul.clock.i matches 303 run function omegaflowey.entity:soul/soul_0/executor/play_music

# Run new logic if the player grabs the act_button
execute if score #soul_0.touched soul.flag matches 1 run function omegaflowey.entity:soul/soul_0/executor/loop/saved
