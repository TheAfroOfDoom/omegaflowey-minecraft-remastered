...
function animated_java:omegaflowey_soul_0_bandaid/as_own_locator_entities { command: 'function omegaflowey.entity:soul/soul_0/bandaid/loop/as_locator with entity @s data' }
