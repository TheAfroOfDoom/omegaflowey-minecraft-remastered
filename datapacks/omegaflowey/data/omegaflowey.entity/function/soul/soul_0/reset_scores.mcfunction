...
scoreboard players set #omegaflowey.soul.0 omegaflowey.soul.executor.clock.length 365
# x/z spans of the bullet grid
scoreboard players set #omegaflowey.soul.0 omegaflowey.soul.bullet.position.dx 825
scoreboard players set #omegaflowey.soul.0 omegaflowey.soul.bullet.position.dz 825
