scoreboard players set #omegaflowey.soul.1.touched omegaflowey.soul.flag 1
...
$execute as $(executor_uuid) run function omegaflowey.entity:soul/soul_1/executor/initialize/touch
