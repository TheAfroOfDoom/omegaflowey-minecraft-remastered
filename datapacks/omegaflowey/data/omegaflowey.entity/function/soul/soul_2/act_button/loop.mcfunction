$execute unless entity $(executor_uuid) run return run function omegaflowey.entity:soul/soul_2/act_button/terminate
...
execute if score @s omegaflowey.soul.bullet.position.x matches ..-3300 run return run \
  function omegaflowey.entity:soul/soul_2/act_button/terminate
