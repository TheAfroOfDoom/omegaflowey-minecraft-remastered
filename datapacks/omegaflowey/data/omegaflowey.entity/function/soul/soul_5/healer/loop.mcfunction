...
function animated_java:omegaflowey_soul_5_flower/as_all_locators { command: 'function omegaflowey.entity:soul/soul_5/healer/loop/as_locator with entity @s data' }
