...
scoreboard players operation @s math.0 += #omega-flowey.bossfight.summit.soul_origin.x omegaflowey.global.flag
scoreboard players operation @s math.1 += #omega-flowey.bossfight.summit.soul_origin.x omegaflowey.global.flag
...
scoreboard players operation @s math.0 += #omega-flowey.bossfight.summit.soul_origin.z omegaflowey.global.flag
scoreboard players operation @s math.1 += #omega-flowey.bossfight.summit.soul_origin.z omegaflowey.global.flag
