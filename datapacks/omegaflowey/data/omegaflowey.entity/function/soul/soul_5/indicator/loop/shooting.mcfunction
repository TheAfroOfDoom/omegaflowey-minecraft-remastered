...
execute if entity @s[tag=soul_5.shooting.rotating] run function omegaflowey.entity:soul/soul_5/indicator/loop/shooting/rotate with storage omegaflowey:soul.5.indicator
