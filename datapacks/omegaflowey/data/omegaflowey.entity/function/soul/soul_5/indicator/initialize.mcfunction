...
data modify storage omegaflowey:soul.5 indicator_uuid set from storage gu:main out
data modify storage omegaflowey:soul.5.indicator indicator_uuid set from storage gu:main out

# Initialize crosshair array
data modify storage omegaflowey:soul.5.indicator crosshairs set value []
