...
execute unless score @s omegaflowey.math.1 matches 0.. run scoreboard players add @s omegaflowey.math.1 360
...
execute if entity @s[tag=is_negative_diff] run scoreboard players operation @s omegaflowey.math.1 *= #-1 omegaflowey.math.const

# omegaflowey.math.1 = diff
# omegaflowey.math.2 = 360 - diff
scoreboard players operation @s omegaflowey.math.2 = @s omegaflowey.math.1
scoreboard players operation @s omegaflowey.math.2 *= #-1 omegaflowey.math.const
scoreboard players add @s omegaflowey.math.2 360
...
execute if entity @s[tag=rotate_other_direction] run scoreboard players operation @s omegaflowey.math.1 *= #-1 omegaflowey.math.const
