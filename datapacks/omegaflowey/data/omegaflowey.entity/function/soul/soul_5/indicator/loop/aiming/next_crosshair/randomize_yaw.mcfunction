...
function omegaflowey.entity:soul/soul_5/indicator/loop/aiming/next_crosshair/randomize_yaw/check_valid with storage soul:soul_5.indicator

# invalid position, try again
execute if score @s math.bool matches 0 run function omegaflowey.entity:soul/soul_5/indicator/loop/aiming/next_crosshair/randomize_yaw
