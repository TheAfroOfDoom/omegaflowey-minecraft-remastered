...
execute if score #omegaflowey.soul.5.touched omegaflowey.soul.flag matches 1 run \
  function omegaflowey.entity:soul/soul_5/executor/loop/saved
...
# Terminate
execute \
  if score #omegaflowey.soul.5.touched omegaflowey.soul.flag matches 0 \
