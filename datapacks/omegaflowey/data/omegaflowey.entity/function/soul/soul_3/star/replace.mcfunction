...
scoreboard players operation #omegaflowey.soul.3.healer_frame omegaflowey.soul.flag = @s aj.omegaflowey_move.frame
...
function omegaflowey.entity:soul/soul_3/healer/summon with entity @s data
