$execute unless entity $(executor_uuid) run return run function omegaflowey.entity:soul/soul_2/indicator/terminate
...
execute if score @s omegaflowey.math.0 matches 0 run function omegaflowey.entity:soul/soul_2/indicator/loop/next_row
