$execute unless entity $(executor_uuid) run return run function omegaflowey.entity:soul/soul_3/bullet/terminate
...
execute \
  ...
  if score #omegaflowey.soul.3.slow_down omegaflowey.soul.flag matches 0 run \
  teleport @s ~-0.4 ~ ~
execute \
  if score #omegaflowey.soul.3.saved omegaflowey.soul.flag matches 0 \
  if score #omegaflowey.soul.3.slow_down omegaflowey.soul.flag matches 1 run \
  function omegaflowey.entity:soul/soul_3/bullet/loop/move_self

execute if score #omegaflowey.soul.3.saved omegaflowey.soul.flag matches 1 run \
  function omegaflowey.entity:soul/soul_3/bullet/loop/move_up
