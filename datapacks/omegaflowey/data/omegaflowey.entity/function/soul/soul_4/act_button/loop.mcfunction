...
execute if entity @s[tag=is_flipped] run return run function omegaflowey.entity:soul/soul_4/act_button/loop/flipped
...
execute if score @s[tag=is_east] omegaflowey.soul.bullet.position.x matches ..-950 run return run \
  function omegaflowey.entity:soul/soul_4/act_button/flip
