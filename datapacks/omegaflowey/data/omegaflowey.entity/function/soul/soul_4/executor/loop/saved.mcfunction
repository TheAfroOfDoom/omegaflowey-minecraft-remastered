...
execute if score @s omegaflowey.math.0 matches 70..152 run \
  function omegaflowey.entity:soul/soul_4/executor/initialize/before_saved
execute if score @s omegaflowey.math.0 matches 153 run return run \
  function omegaflowey.entity:soul/soul_4/executor/initialize/saved with storage omegaflowey:soul.4
