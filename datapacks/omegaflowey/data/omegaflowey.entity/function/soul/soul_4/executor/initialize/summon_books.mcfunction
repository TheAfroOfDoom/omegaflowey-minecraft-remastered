...
execute positioned ^5 ^-3.8 ^20 run function omegaflowey.entity:soul/soul_3/indicator/summon
execute positioned ^5 ^-3.8 ^26 run function omegaflowey.entity:soul/soul_3/indicator/summon
