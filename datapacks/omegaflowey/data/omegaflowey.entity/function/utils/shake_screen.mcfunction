...
execute if score @s omegaflowey.math.1 matches 1 run scoreboard players operation @s omegaflowey.math.0 *= #-1 omegaflowey.math.const
execute store result storage utils:shake_screen yaw float 0.1 run scoreboard players get @s omegaflowey.math.0
...
execute store result score @s omegaflowey.math.1 run random value 0..1
execute if score @s omegaflowey.math.1 matches 1 run scoreboard players operation @s omegaflowey.math.2 *= #-1 omegaflowey.math.const
execute store result storage utils:shake_screen pitch float 0.1 run scoreboard players get @s omegaflowey.math.2
