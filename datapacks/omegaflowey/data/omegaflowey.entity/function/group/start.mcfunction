...
execute if entity @s[scores={omegaflowey.group.id.tree.level=1}] run scoreboard players operation #group.id.restore omegaflowey.group.id = @s omegaflowey.group.id
