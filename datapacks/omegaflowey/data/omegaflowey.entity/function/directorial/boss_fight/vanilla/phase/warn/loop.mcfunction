...
execute if score @s omegaflowey.boss-fight.warn.clock.i matches 0 run function omegaflowey.entity:directorial/boss_fight/vanilla/phase/warn/initialize/after_delay
