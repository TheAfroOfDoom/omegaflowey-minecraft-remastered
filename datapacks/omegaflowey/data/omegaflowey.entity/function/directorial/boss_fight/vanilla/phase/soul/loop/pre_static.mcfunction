...
execute if score @s omegaflowey.boss-fight.progress.clock.i matches 0 run function omegaflowey.entity:directorial/boss_fight/vanilla/phase/soul/loop/next_event
