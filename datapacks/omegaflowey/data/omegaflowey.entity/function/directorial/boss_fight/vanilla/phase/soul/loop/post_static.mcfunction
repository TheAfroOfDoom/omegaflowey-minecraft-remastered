...
execute if score @s boss-fight.progress.clock.i = @s boss-fight.progress.clock.total run function omegaflowey.entity:directorial/boss_fight/vanilla/phase/soul/terminate
