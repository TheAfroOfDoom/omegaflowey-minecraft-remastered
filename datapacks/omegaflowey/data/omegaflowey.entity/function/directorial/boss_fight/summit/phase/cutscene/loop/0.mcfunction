...
execute if score @s omegaflowey.boss-fight.cutscene.clock.i matches 382 run return run \
  function omegaflowey.entity:directorial/boss_fight/summit/phase/cutscene/loop/0/blind_player with storage omegaflowey:bossfight
