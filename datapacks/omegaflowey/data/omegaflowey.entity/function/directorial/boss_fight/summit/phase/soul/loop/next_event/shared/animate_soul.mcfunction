...
function omegaflowey.entity:directorial/boss_fight/summit/phase/soul/loop/next_event/shared/animate_soul/target_soul_model with storage omegaflowey:bossfight
