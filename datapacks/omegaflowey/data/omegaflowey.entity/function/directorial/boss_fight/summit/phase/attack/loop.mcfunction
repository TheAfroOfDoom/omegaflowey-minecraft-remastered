...
# Terminate
execute if score @s boss-fight.attack.clock.i >= @s boss-fight.attack.clock.total run function omegaflowey.entity:directorial/boss_fight/summit/phase/attack/terminate
