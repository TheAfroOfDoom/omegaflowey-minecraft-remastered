...
execute positioned -11 44 -12.5 rotated -10 20 run function animated_java:omegaflowey_petal_pipe_circle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root] add petal_pipe.right
# Left-lower petal pipe
execute positioned 11 44 -12.5 rotated -170 -20 run function animated_java:omegaflowey_petal_pipe_circle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root,tag=!petal_pipe.right] add petal_pipe.left
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root] add petal_pipe.lower

## Middle petal pipes
# Right-middle petal pipe
execute positioned -14 48 -6.5 rotated -20 40 run function animated_java:omegaflowey_petal_pipe_middle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_middle.root] add petal_pipe.right
# Left-middle petal pipe
execute positioned 14 48 -6.5 rotated -160 -40 run function animated_java:omegaflowey_petal_pipe_middle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_middle.root,tag=!petal_pipe.right] add petal_pipe.left
...
execute positioned -11 63 4 rotated -10 45 run function animated_java:omegaflowey_petal_pipe_circle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root,tag=!petal_pipe.lower] add petal_pipe.right
# Left-upper petal pipe
execute positioned 11 63 4 rotated -170 -45 run function animated_java:omegaflowey_petal_pipe_circle/summon { args: {} }
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root,tag=!petal_pipe.lower,tag=!petal_pipe.right] add petal_pipe.left
tag @e[tag=aj.omegaflowey_petal_pipe_circle.root,tag=!petal_pipe.lower] add petal_pipe.upper
