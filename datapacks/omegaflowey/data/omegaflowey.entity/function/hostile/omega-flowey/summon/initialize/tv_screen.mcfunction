...
execute if score #omegaflowey.summon.tag_variant global.flag matches 1 run function omegaflowey.entity:hostile/omega-flowey/summon/initialize/tv_screen/bossfight
execute if score #omegaflowey.summon.tag_variant global.flag matches 2 run tag @s add tv_screen.soul
execute if score #omegaflowey.summon.tag_variant global.flag matches 3 run function omegaflowey.main:summit/room/outside/setup/tv_screen
