...
data modify storage omegaflowey:attack.x-bullets-upper-save-states current_state.summon_function set value "omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/indicator/states/load_state/resummon"
...
# Scores
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_bullets_remaining int 1 run scoreboard players get @s omegaflowey.attack.bullets.remaining
...
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_position_x int 1 run scoreboard players get @s omegaflowey.attack.position.x
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_position_y int 1 run scoreboard players get @s omegaflowey.attack.position.y
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_position_z int 1 run scoreboard players get @s omegaflowey.attack.position.z
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_indicator_yaw int 1 run scoreboard players get @s omegaflowey.attack.indicator.yaw
execute store result storage omegaflowey:attack.x-bullets-upper-save-states current_state.scores.attack_theta int 1 run scoreboard players get @s omegaflowey.attack.theta
