...
execute if score @s omegaflowey.attack.clock.i matches 0 run scoreboard players add #attack-friendliness-pellets attack.indicator.clock.delay 6
...
# TODO(43): this is so unbelievably hacky
execute if score @s omegaflowey.attack.clock.i matches 0 run scoreboard players remove #attack-friendliness-pellets attack.indicator.clock.delay 6
