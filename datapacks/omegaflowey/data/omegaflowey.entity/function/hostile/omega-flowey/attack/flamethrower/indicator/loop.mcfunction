...
execute if score @s omegaflowey.attack.clock.i matches 0 run playsound omega-flowey:attack.flamethrower.enter hostile @a ~ ~ ~ 5
execute if score @s omegaflowey.attack.clock.i matches 0..5 run teleport @s ~ ~ ~3.0

# Move flamethrowers backward
execute if score @s omegaflowey.attack.clock.i matches 49 run playsound omega-flowey:attack.flamethrower.exit hostile @a ~ ~ ~ 5
execute if score @s omegaflowey.attack.clock.i matches 49..54 run teleport @s ~ ~ ~-3.0
