...
scoreboard players set #omegaflowey.attack.homing-vines-save-states omegaflowey.attack.weight 3
scoreboard players set #omegaflowey.attack.x-bullets-upper-save-states omegaflowey.attack.weight 3
