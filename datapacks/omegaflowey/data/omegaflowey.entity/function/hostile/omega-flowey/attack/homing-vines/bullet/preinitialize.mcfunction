execute if score #omegaflowey.summon.tag_variant global.flag matches 1 run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/bullet/initialize
