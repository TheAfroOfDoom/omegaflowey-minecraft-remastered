...
scoreboard players set #omegaflowey.attack.flamethrower omegaflowey.attack.weight 3
...
scoreboard players set #omegaflowey.attack.x-bullets-upper omegaflowey.attack.weight 3
