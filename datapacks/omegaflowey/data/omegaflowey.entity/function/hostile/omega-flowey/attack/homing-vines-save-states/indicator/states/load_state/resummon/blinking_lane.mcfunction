...
execute as @e[tag=homing-vines-blinking-lane-new] run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines-save-states/indicator/states/load_state/blinking_lane with storage omegaflowey:attack.homing-vines-save-states
