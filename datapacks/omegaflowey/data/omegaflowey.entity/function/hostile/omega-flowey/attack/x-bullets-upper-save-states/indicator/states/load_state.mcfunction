...
execute store result score @s omegaflowey.attack.position.x run data get storage attack:x-bullets-upper-save-states state_scores.attack_position_x
execute store result score @s omegaflowey.attack.position.y run data get storage attack:x-bullets-upper-save-states state_scores.attack_position_y
execute store result score @s omegaflowey.attack.position.z run data get storage attack:x-bullets-upper-save-states state_scores.attack_position_z
