...
scoreboard players set #attack-dentata-snakes omegaflowey.attack.bullets.clock.delay 4
scoreboard players set #attack-dentata-snakes omegaflowey.attack.bullets.scale 100
