...
execute if entity @s[tag=attack.random.previous_attack.bomb] run scoreboard players operation #attack-bomb omegaflowey.attack.weight -= @s omegaflowey.attack.weight
execute if entity @s[tag=attack.random.previous_attack.bomb] run tag @s remove attack.random.previous_attack.bomb

execute if entity @s[tag=attack.random.previous_attack.dentata-snakes] run scoreboard players operation #attack-dentata-snakes omegaflowey.attack.weight -= @s omegaflowey.attack.weight
...
execute if entity @s[tag=attack.random.previous_attack.flies] run scoreboard players operation #attack-flies omegaflowey.attack.weight -= @s omegaflowey.attack.weight
execute if entity @s[tag=attack.random.previous_attack.flies] run tag @s remove attack.random.previous_attack.flies

execute if entity @s[tag=attack.random.previous_attack.friendliness-pellets] run scoreboard players operation #attack-friendliness-pellets omegaflowey.attack.weight -= @s omegaflowey.attack.weight
...
execute if entity @s[tag=attack.random.previous_attack.homing-vines-save-states] run scoreboard players operation #attack-homing-vines-save-states omegaflowey.attack.weight -= @s omegaflowey.attack.weight
...
execute if entity @s[tag=attack.random.previous_attack.x-bullets-upper-save-states] run scoreboard players operation #attack-x-bullets-upper-save-states omegaflowey.attack.weight -= @s omegaflowey.attack.weight
