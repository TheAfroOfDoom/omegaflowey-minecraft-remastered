...
data modify storage attack:homing-vines-save-states current_state.summon_function set value "omegaflowey.entity:hostile/omega-flowey/attack/homing-vines-save-states/bullet/states/load_state/resummon"
