...
execute store result score #omegaflowey.attack.x-bullets-upper-save-states aj.omegaflowey_look_around.frame run data get entity @s data.scores.aj_upper_eye_aj_frame
execute as @e[tag=aj.omegaflowey_upper_eye.root] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/executor/states/load_state/upper_eye
