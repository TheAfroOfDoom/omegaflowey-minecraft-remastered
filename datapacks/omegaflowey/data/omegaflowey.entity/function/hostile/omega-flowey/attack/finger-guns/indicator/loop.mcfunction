...
# Summon laser after `omegaflowey.attack.indicator.clock.delay`
...
execute if score @s omegaflowey.attack.clock.i >= @s omegaflowey.attack.indicator.clock.length run function omegaflowey.entity:hostile/omega-flowey/attack/finger-guns/indicator/terminate
