...
function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/executor/states/load_all_states/iterate/summon with entity @s data.saved_states[-1]
