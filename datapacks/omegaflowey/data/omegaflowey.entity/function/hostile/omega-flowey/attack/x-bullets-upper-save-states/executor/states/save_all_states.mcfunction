...
execute as @a[tag=omegaflowey.player.fighting_flowey] at @s run function entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/player/states/save_state
