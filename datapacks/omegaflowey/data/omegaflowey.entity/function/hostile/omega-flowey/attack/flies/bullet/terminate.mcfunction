...
execute as @e[scores={group.id=0},tag=attack-indicator,tag=flies] run function omegaflowey.entity:hostile/omega-flowey/attack/flies/indicator/maybe_terminate
