...
execute if score @s omegaflowey.attack.clock.i matches -5 run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/indicator/loop/visualize_blinking_lane with entity @s data
...
execute if score @s omegaflowey.attack.clock.i matches 0 run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/indicator/loop/terminate_blinking_lane with entity @s data
