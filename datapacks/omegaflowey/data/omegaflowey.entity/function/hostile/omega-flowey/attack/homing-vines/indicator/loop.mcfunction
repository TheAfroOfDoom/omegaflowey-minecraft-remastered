...
execute if score @s attack.bullets.count < @s attack.bullets.total run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/indicator/loop/presummon_bullet

# Terminate after all bullets have been summoned
execute if score @s attack.bullets.count = @s attack.bullets.total run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/indicator/terminate
