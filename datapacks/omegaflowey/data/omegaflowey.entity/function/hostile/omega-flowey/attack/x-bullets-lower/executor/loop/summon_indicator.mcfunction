...
$execute at $(attack_lower_eye_right_locator_uuid) summon minecraft:marker run \
  function entity:hostile/omega-flowey/attack/x-bullets-lower/indicator/initialize/right
$execute at $(attack_lower_eye_left_locator_uuid) summon minecraft:marker run \
  function entity:hostile/omega-flowey/attack/x-bullets-lower/indicator/initialize/left
