...
execute at @e[tag=aj.omegaflowey_upper_eye.locator.pupil] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/indicator/summon/x-bullets-upper/raw
