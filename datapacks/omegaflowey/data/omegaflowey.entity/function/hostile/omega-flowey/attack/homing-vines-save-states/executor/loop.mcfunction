...
execute if score @s attack.clock.i matches 0..13 at @r[tag=omegaflowey.player.fighting_flowey] run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines-save-states/indicator/summon
