...
execute if score #homing-vines-save-states.did_player_take_damage omegaflowey.attack.flag matches 1 run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines-save-states/executor/loop/after_load_state
execute if score #homing-vines-save-states.did_player_take_damage omegaflowey.attack.flag matches 1 run return 0
