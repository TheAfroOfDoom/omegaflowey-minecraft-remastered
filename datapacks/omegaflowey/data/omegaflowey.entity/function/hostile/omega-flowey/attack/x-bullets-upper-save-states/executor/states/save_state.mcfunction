...
execute store result entity @s data.scores.aj_upper_eye_aj_frame int 1 run scoreboard players get @e[tag=aj.omegaflowey_upper_eye.root,limit=1] aj.omegaflowey_look_around.frame
