...
execute if score @s attack.clock.i matches 0 as @e[tag=aj.upper_eye.root] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper/executor/loop/pause_eye
...
execute if score @s attack.clock.i matches 21 as @e[tag=aj.upper_eye.root] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper/executor/terminate/upper_eye
