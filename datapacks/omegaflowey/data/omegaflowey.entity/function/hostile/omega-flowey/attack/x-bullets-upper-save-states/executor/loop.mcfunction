...
execute if score @s omegaflowey.attack.clock.i matches 0 as @e[tag=aj.omegaflowey_upper_eye.root] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper/executor/loop/pause_eye
...
execute if score @s omegaflowey.math.0 matches 0 if score @s omegaflowey.attack.indicator.remaining matches 1.. run \
  function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/indicator/summon/x-bullets-upper with storage omegaflowey:bossfight
...
execute if score @s omegaflowey.attack.clock.i matches 21 as @e[tag=aj.omegaflowey_upper_eye.root] run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper/executor/terminate/upper_eye

# Don't actually load-state if a player has taken damage
execute if score #omegaflowey.attack.x-bullets-upper-save-states.did_player_take_damage omegaflowey.attack.flag matches 1 run function omegaflowey.entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/executor/loop/after_load_state
execute if score #omegaflowey.attack.x-bullets-upper-save-states.did_player_take_damage omegaflowey.attack.flag matches 1 run return 0
