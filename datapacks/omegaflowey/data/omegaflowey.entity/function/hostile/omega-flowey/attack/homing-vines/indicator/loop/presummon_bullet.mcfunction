...
# Summon bullet
execute at @s run function omegaflowey.entity:hostile/omega-flowey/attack/homing-vines/indicator/loop/presummon_bullet/face_player_location with storage omegaflowey:attack.homing-vines
