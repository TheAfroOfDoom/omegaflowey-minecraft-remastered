...
execute if score @s attack.clock.i matches 0 run function omegaflowey.entity:hostile/omega-flowey/attack/flies/indicator/loop/maybe_stop_buzzing

# Terminate after X ticks (Y seconds)
execute if score @s attack.clock.i matches 9.. run function omegaflowey.entity:hostile/omega-flowey/attack/flies/indicator/terminate
