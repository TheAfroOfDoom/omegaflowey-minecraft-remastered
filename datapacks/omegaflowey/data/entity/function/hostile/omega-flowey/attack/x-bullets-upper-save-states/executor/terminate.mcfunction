...
execute as @e[tag=player-marker,tag=x-bullets-upper-save-states] run function entity:hostile/omega-flowey/attack/x-bullets-upper-save-states/player/marker/terminate
