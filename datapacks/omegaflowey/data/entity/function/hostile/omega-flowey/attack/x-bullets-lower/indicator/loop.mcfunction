...
execute if score @s attack.bullets.remaining matches 1.. run \
  function entity:hostile/omega-flowey/attack/x-bullets-lower/indicator/loop/presummon_bullet

# Terminate
execute if score @s attack.bullets.remaining matches ..0 run \
  function entity:hostile/omega-flowey/attack/x-bullets-lower/indicator/terminate with entity @s data
