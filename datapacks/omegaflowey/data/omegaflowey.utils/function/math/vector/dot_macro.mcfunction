...
execute store result score #omegaflowey.utils:math.vector.dot omegaflowey.math.1 run data get storage utils:math.vector.dot out
...
execute store result storage utils:math.vector.dot out int 1 run scoreboard players get #omegaflowey.utils:math.vector.dot omegaflowey.math.0
