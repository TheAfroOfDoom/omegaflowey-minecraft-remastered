...
data remove storage omegaflowey:utils.math.distance_squared y1
data remove storage omegaflowey:utils.math.distance_squared z0
data remove storage omegaflowey:utils.math.distance_squared z1
data remove storage omegaflowey:utils.math.distance_squared out
