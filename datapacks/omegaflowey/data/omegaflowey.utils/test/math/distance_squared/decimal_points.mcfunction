...
data merge storage omegaflowey:utils.math.distance_squared { x1: 1.1, y1: 2.2, z1: 3.3 }
function omegaflowey.utils:math/distance_squared
execute store result score #omegaflowey.utils:math.distance_squared omegaflowey.math.0 run data get storage omegaflowey:utils.math.distance_squared out 100
