...
execute store result score #utils:math.distance_squared omegaflowey.math.0 run data get storage utils:math.distance_squared out 100
assert score #utils:math.distance_squared omegaflowey.math.0 matches 1694
...
assert score #utils:math.distance_squared omegaflowey.math.0 matches 16
