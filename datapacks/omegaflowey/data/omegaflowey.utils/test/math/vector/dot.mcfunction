...
execute store result score #utils:math.vector.dot omegaflowey.math.0 run data get storage utils:math.vector.dot out
assert score #utils:math.vector.dot omegaflowey.math.0 matches 0
...
function omegaflowey.utils:math/vector/dot
execute store result score #utils:math.vector.dot omegaflowey.math.0 run data get storage utils:math.vector.dot out
assert score #utils:math.vector.dot omegaflowey.math.0 matches 100
...
function omegaflowey.utils:math/vector/dot
execute store result score #utils:math.vector.dot omegaflowey.math.0 run data get storage utils:math.vector.dot out
assert score #utils:math.vector.dot omegaflowey.math.0 matches -300

# full vectors
data merge storage utils:math.vector.dot { u: { x: 1, y: 2, z: 3 }, v: { x: 4, y: 5, z: 6 } }
function omegaflowey.utils:math/vector/dot
execute store result score #utils:math.vector.dot omegaflowey.math.0 run data get storage utils:math.vector.dot out
assert score #utils:math.vector.dot omegaflowey.math.0 matches 3200

# supports decimal values up to 100th place
data merge storage utils:math.vector.dot { u: { x: 1.5, y: 2.1, z: 3.12 }, v: { x: 3, y: 5, z: 7 } }
function omegaflowey.utils:math/vector/dot
execute store result score #utils:math.vector.dot omegaflowey.math.0 run data get storage utils:math.vector.dot out
assert score #utils:math.vector.dot omegaflowey.math.0 matches 3684
