...
execute store result score #utils:math.max omegaflowey.math.0 run data get storage utils:math.max out
assert score #utils:math.max omegaflowey.math.0 matches 10

data merge storage utils:math.max { a: 0, b: 1 }
function omegaflowey.utils:math/max
execute store result score #utils:math.max omegaflowey.math.0 run data get storage utils:math.max out
assert score #utils:math.max omegaflowey.math.0 matches 1

data merge storage utils:math.max { a: 2, b: 1 }
function omegaflowey.utils:math/max
execute store result score #utils:math.max omegaflowey.math.0 run data get storage utils:math.max out
assert score #utils:math.max omegaflowey.math.0 matches 2
