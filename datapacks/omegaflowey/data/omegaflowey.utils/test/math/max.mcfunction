...
execute store result score #omegaflowey.utils:math.max omegaflowey.math.0 run data get storage utils:math.max out
assert score #omegaflowey.utils:math.max omegaflowey.math.0 matches 10

data merge storage utils:math.max { a: 0, b: 1 }
function omegaflowey.utils:math/max
execute store result score #omegaflowey.utils:math.max omegaflowey.math.0 run data get storage utils:math.max out
assert score #omegaflowey.utils:math.max omegaflowey.math.0 matches 1
