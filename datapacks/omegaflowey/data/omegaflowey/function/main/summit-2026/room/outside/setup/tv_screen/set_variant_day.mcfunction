scoreboard players set #omegaflowey.decorative.tvscreen.is_day_variant omegaflowey.global.flag 1
...
schedule function omegaflowey:main/summit-2026/room/outside/setup/tv_screen/set_variant_day/scheduled 10t replace
