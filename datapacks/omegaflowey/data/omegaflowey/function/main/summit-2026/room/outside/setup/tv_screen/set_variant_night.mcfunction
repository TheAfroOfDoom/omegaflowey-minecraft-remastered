scoreboard players set #omegaflowey.decorative.tvscreen.is_day_variant omegaflowey.global.flag 0
...
schedule function omegaflowey:main/summit-2026/room/outside/setup/tv_screen/set_variant_night/scheduled 10t replace
