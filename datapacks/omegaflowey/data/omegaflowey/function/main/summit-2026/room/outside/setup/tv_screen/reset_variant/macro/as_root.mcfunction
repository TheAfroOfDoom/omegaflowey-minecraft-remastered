...
execute unless entity @s[tag=is_daytime] run function omegaflowey:main/summit-2026/room/outside/setup/tv_screen/set_variant_night
execute if entity @s[tag=is_daytime] run function omegaflowey:main/summit-2026/room/outside/setup/tv_screen/set_variant_day
