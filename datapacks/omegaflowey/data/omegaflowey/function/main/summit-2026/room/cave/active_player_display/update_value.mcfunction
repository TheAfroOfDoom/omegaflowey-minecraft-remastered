...
$execute as $(active_player_display_uuid) run \
  function omegaflowey:main/summit-2026/room/cave/active_player_display/as_text_display with storage omegaflowey:bossfight

function omegaflowey:main/summit-2026/room/cave/active_player_health_display/update_value with storage omegaflowey:bossfight
