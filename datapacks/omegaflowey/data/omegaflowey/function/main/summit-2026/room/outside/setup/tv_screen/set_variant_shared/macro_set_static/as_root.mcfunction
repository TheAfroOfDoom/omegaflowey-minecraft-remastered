...
execute unless entity @s[tag=is_daytime] run function aj:omegaflowey_tv_screen/variants/static/apply
execute if entity @s[tag=is_daytime] run function aj:omegaflowey_tv_screen/variants/static_noglow/apply
