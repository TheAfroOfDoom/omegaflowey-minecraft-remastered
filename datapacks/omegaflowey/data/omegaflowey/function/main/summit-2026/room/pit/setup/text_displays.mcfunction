summon minecraft:text_display 64.0 52.75 -15.0 {\
  Tags: [ \
...
summon minecraft:text_display 64.0 52.0 -15.0 { \
  Tags: [ \
    "summit.booth_entity.omegaflowey", \
    "summit.static", \
    "omega-flowey-remastered", \
...
summon minecraft:text_display 72.0 52.0 -23.0 { \
  Tags: [ \
    "summit.booth_entity.omegaflowey", \
    "summit.static", \
    "omega-flowey-remastered", \
...
summon minecraft:text_display 72.0 52.5 -23.0 { \
  Tags: [ \
    "summit.booth_entity.omegaflowey", \
    "summit.static", \
    "omega-flowey-remastered", \
...
summon minecraft:text_display 72.0 55.25 -8.01 { \
  Tags: [ \
    "summit.booth_entity.omegaflowey", \
    "summit.static", \
    "omega-flowey-remastered", \
