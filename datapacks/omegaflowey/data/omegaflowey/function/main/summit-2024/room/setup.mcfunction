...
function omegaflowey:main/summit-2024/room/cave/setup
function omegaflowey:main/summit-2024/room/outside/setup
function omegaflowey:main/summit-2024/room/pit/setup
