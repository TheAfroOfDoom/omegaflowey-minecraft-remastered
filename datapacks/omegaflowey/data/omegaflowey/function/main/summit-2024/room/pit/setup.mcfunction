...
execute positioned -110.5 41.0 38.5 rotated -168 0 run function aj:omegaflowey_flowercontributor/summon { args: { variant: 'default' } }
...
function omegaflowey:main/summit-2024/room/pit/setup/text_displays

execute unless score #omegaflowey.setup_flags.dont_place_blocks omegaflowey.global.flag matches 1 run \
  function omegaflowey:main/summit-2024/room/pit/setup/place_pink_shulker_boxes
