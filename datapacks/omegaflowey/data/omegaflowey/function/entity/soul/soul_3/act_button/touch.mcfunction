...
function omegaflowey:entity/directorial/boss_fight/summit-2026/soul_origin/at/position { \
  command: "execute positioned ~9.5 ~7.0 ~ run function omegaflowey:entity/soul/shared/call_for_help_display/summon" \
}
