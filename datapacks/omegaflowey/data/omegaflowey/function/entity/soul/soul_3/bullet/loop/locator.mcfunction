...
execute positioned ~ ~-0.7 ~ run function omegaflowey:entity/utils/damage with storage omegaflowey:utils.damage
execute positioned ~ ~-1.7 ~ run function omegaflowey:entity/utils/damage with storage omegaflowey:utils.damage
