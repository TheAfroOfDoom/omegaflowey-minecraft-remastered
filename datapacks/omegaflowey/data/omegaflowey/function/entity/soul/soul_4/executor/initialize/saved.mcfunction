# Update state flag
scoreboard players set #omegaflowey.soul.4.saved omegaflowey.soul.flag 1

function omegaflowey:entity/shared/run_as_active_player_or_spectator { command: \
  'execute at @s run function omegaflowey:entity/soul/soul_4/executor/initialize/saved/as_player' \
}
...
$execute as $(act_button_uuid) run function omegaflowey:entity/soul/soul_4/act_button/terminate
$execute as $(soul_model_uuid) run function animated_java:omegaflowey_soul/variants/4/apply
