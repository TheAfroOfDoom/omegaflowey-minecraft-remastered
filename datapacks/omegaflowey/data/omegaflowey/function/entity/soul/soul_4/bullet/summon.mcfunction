...
$execute unless score #omegaflowey.soul.4.saved omegaflowey.soul.flag matches 1 \
  ...
  function aj:omegaflowey_soul_4_bullet/summon { args: { animation: 'omegaflowey_idle', start_animation: true } }

$execute if score #omegaflowey.soul.4.saved omegaflowey.soul.flag matches 1 \
  rotated ~$(bullet_yaw) 20.0 run \
  function aj:omegaflowey_soul_4_bullet/summon { args: { animation: 'omegaflowey_idle', start_animation: true, variant: 'egg' } }
