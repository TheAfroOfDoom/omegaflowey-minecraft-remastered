...
execute if score #omegaflowey.bossfight.done omegaflowey.global.flag matches 1 run \
  function omegaflowey:entity/directorial/boss_fight/summit-2026/phase/soul/terminate/final with storage omegaflowey:bossfight
...
# execute as @a at @s unless entity @s[tag=!omegaflowey.player.fighting_flowey, tag=!omegaflowey.player.room.spectator_box] run function omegaflowey:entity/directorial/boss_fight/summit-2026/soul_origin/to_origin
