...
execute if score @s omegaflowey.boss-fight.progress.phase.i matches 3 run \
  function omegaflowey:entity/soul/soul_3/start
execute if score @s omegaflowey.boss-fight.progress.phase.i matches 4 run \
  function omegaflowey:entity/soul/soul_4/start
