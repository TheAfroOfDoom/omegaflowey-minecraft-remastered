...
function omegaflowey:entity/directorial/boss_fight/vanilla/origin/at { command: "execute positioned ~ ~ ~20.5 rotated 180 0 run function omegaflowey:entity/directorial/boss_fight/vanilla/phase/cutscene/initialize/intro_flashing_red/summon_arena_box"}
