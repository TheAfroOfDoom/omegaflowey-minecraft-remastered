...
execute if score #omegaflowey.bossfight.done omegaflowey.global.flag matches 1 run \
  function omegaflowey:entity/directorial/boss_fight/summit-2024/phase/soul/terminate/final with storage omegaflowey:bossfight
...
# Next phase
function omegaflowey:entity/directorial/boss_fight/summit-2024/phase/attack/initialize

# # Move players to main arena
# execute as @a at @s unless entity @s[tag=!omegaflowey.player.fighting_flowey, tag=!omegaflowey.player.room.spectator_box] run function omegaflowey:entity/directorial/boss_fight/summit-2024/soul_origin/to_origin
...
function omegaflowey:entity/directorial/boss_fight/summit-2024/origin/at { \
...
$execute as $(bossfight_tvscreen_uuid) run function aj:omegaflowey_tv_screen/variants/default/apply
