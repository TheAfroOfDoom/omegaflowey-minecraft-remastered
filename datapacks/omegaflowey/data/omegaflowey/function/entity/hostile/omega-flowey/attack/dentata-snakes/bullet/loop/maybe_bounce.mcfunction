...
function omegaflowey:entity/directorial/boss_fight/summit-2026/origin/at/position { \
  command: "execute positioned ~11.0 ~-7.0 ~1000.0 if entity @s[dx=-1000,dy=10,dz=-2000] run \
...
data modify storage omegaflowey:attack.dentata-snakes.bounce x_negative_dx set value 25
...
data modify storage omegaflowey:attack.dentata-snakes.bounce x_positive_dx set value -25
...
data modify storage omegaflowey:attack.dentata-snakes.bounce z_negative_dz set value 50
...
data modify storage omegaflowey:attack.dentata-snakes.bounce z_positive_dz set value -50
