...
execute store result score @s omegaflowey.attack.position.x run random value 85..315
...
execute store result score @s omegaflowey.attack.position.z run random value -150..150
