...
# Summon indicator
$execute at $(active_player_uuid) run function omegaflowey:entity/directorial/boss_fight/summit-2026/origin/at/y { \
  command: "execute positioned ~ ~-4.5 ~ run function omegaflowey:entity/hostile/omega-flowey/attack/friendliness-pellets/indicator/summon" \
}
