# Randomize delta-z-position of indicator at (z: omegaflowey.player.Position.z, dz: [-0.50..0.50])
...
# Randomize delta-x-position of indicator at (x: omegaflowey.player.Position.x, dx: [-1.00..1.00])
