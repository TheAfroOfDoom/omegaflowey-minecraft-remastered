execute if entity @s[tag=aj.omegaflowey_arm_vine.root] run function aj:omegaflowey_arm_vine/animations/omegaflowey_move/resume
execute if entity @s[tag=aj.omegaflowey_arm_vine_right.root] run function aj:omegaflowey_arm_vine_right/animations/omegaflowey_move/resume

execute if entity @s[tag=aj.omegaflowey_mouth.root] run function aj:omegaflowey_mouth/animations/omegaflowey_move/resume
...
execute \
  ...
  run function aj:omegaflowey_nose/animations/omegaflowey_move/resume
...
execute if entity @s[tag=aj.omegaflowey_lower_eye.root] run function aj:omegaflowey_lower_eye/animations/omegaflowey_look_around/resume
...
execute if entity @s[tag=aj.omegaflowey_upper_eye.root] run function aj:omegaflowey_upper_eye/animations/omegaflowey_look_around/resume
