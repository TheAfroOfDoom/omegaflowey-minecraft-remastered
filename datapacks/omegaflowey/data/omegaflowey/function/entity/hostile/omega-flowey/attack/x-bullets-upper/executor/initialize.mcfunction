...
$execute as $(attack_upper_eye_right_uuid) run function aj:omegaflowey_upper_eye/at_locator { \
  name: 'pupil', \
  command: 'function omegaflowey:entity/hostile/omega-flowey/attack/x-bullets-upper/executor/initialize/effects' \
}
...
$execute as $(attack_upper_eye_right_uuid) run function aj:omegaflowey_upper_eye/variants/white/apply
$execute as $(attack_upper_eye_left_uuid) run function aj:omegaflowey_upper_eye/variants/white/apply
