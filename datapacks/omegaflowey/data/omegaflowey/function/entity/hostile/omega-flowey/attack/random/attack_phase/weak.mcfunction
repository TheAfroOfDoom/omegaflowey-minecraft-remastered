...
scoreboard players set #omegaflowey.attack.x-bullets-lower-weak omegaflowey.attack.weight 1
scoreboard players set #omegaflowey.attack.x-bullets-upper-weak omegaflowey.attack.weight 1
