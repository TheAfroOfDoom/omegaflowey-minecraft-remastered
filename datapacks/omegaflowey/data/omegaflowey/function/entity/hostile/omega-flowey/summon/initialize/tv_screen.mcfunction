...
execute if score #omegaflowey.summon.tag_variant omegaflowey.global.flag matches 3 run function omegaflowey:main/summit-2024/room/outside/setup/tv_screen

execute \
  if score #omegaflowey.summon.tag_variant omegaflowey.global.flag matches 1..2 \
  on passengers if entity @s[type=minecraft:item_display, tag=aj.global.data] \
