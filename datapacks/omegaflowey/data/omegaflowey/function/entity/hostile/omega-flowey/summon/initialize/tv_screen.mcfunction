...
execute if score #omegaflowey.summon.tag_variant omegaflowey.global.flag matches 3 run function omegaflowey:main/summit-2026/room/outside/setup/tv_screen
