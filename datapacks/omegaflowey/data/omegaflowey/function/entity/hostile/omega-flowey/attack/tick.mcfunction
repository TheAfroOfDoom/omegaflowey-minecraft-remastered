...
execute if entity @s[tag=x-bullets-lower-weak] run function omegaflowey:entity/hostile/omega-flowey/attack/x-bullets-lower-weak/tick
execute if entity @s[tag=x-bullets-upper] run function omegaflowey:entity/hostile/omega-flowey/attack/x-bullets-upper/tick
execute if entity @s[tag=x-bullets-upper-weak] run function omegaflowey:entity/hostile/omega-flowey/attack/x-bullets-upper-weak/tick
