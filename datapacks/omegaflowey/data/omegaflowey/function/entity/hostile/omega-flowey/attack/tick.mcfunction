execute if entity @s[tag=bomb] run return run function omegaflowey:entity/hostile/omega-flowey/attack/bomb/tick
execute if entity @s[tag=dentata-snakes] run return run function omegaflowey:entity/hostile/omega-flowey/attack/dentata-snakes/tick
execute if entity @s[tag=finger-guns] run return run function omegaflowey:entity/hostile/omega-flowey/attack/finger-guns/tick
execute if entity @s[tag=flamethrower] run return run function omegaflowey:entity/hostile/omega-flowey/attack/flamethrower/tick
