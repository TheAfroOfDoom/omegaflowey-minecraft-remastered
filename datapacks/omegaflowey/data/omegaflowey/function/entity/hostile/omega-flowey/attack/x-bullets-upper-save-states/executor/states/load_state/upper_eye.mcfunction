...
function aj:omegaflowey_upper_eye/animations/omegaflowey_look_around/apply_frame with storage omegaflowey:attack.x-bullets-upper-save-states
tag @s remove aj.omegaflowey_upper_eye.animation.omegaflowey_look_around.playing
function aj:omegaflowey_upper_eye/variants/colorful/apply
