...
const disableShading = ({ resourcePackRootDir }) => {
  const cases = [
    ...
    ['omegaflowey_tv_screen', 'winner_soul_0', 'winner_0'],
    ['omegaflowey_tv_screen', 'winner_soul_1', 'winner_1'],
    ['omegaflowey_tv_screen', 'winner_soul_2', 'winner_2'],
    ['omegaflowey_tv_screen', 'winner_soul_3', 'winner_3'],
    ['omegaflowey_tv_screen', 'winner_soul_4', 'winner_4'],
    ['omegaflowey_tv_screen', 'winner_soul_5', 'winner_5'],
