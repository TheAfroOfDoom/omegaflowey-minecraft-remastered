...
const setInterpolationDurationZeroAllFrames = (rootDir) => {
  const stepAnimations = [
    ...
    ['omegaflowey_soul_3_word_0', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_1', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_2', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_3', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_4', 'omegaflowey_shake'],
    ...
    ['omegaflowey_soul_3_word_10', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_11', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_12', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_13', 'omegaflowey_shake'],
    ['omegaflowey_soul_3_word_14', 'omegaflowey_shake'],
