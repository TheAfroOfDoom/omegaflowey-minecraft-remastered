...
const applicableExtensions = [
  'datapacks/omegaflowey/data/entity/function/directorial/boss_fight/summit-2026/origin/setup.mcfunction',
  'datapacks/omegaflowey/data/entity/function/directorial/boss_fight/summit-2026/soul_origin/setup.mcfunction',
];
...
const originScoresEqual = (file, options) => {
  ...
  const getFunctionPath = (subpath) =>
    `datapacks/omegaflowey/data/entity/function/directorial/boss_fight/summit-2026/${originType}/at/${subpath}.mcfunction`;
